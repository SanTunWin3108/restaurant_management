...
<head>
    ...
    <!-- Daterange picker -->
    <link href="{{asset('adminLTE/plugins/daterangepicker/daterangepicker-bs3.css')}}" rel="stylesheet"
        type="text/css" />
...
<body class="skin-blue">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa-solid fa-circle-user"></i> <span style="margin-left: 8px;">Account</span>
                    ...
                    <li class="treeview active">
                        <a href="#">
                            <i class="fa-solid fa-chart-line"></i> <span style="margin-left: 8px;">Dashboard</span>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa-solid fa-list-check"></i> <span style="margin-left: 8px;">Orders</span>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa-solid fa-book"></i> <span style="margin-left: 8px;">Categories</span>
                        </a>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa-solid fa-table"></i> <span style="margin-left: 8px;">Products</span>
                        </a>
                    </li>
                </ul>
            </section>
    ...
    <!-- jvectormap -->
    <script src="{{asset('adminLTE/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js')}}" type="text/javascript">
    </script>
    <script src="{{asset('adminLTE/plugins/jvectormap/jquery-jvectormap-world-mill-en.js')}}" type="text/javascript">
    </script>
    <!-- jQuery Knob Chart -->
